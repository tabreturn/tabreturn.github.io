...
I've begun working on a [Thonny plug-in](https://pypi.org/project/thonny-py5mode/) that automates the installation steps I cover in this post. You can check out the [project repo](https://github.com/tabreturn/thonny-py5mode) to see how this work on **thonny-py5mode** progressing*.
</p>
