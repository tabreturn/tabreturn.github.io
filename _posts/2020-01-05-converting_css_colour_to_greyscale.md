...
Simple -- the same way they display colour. As explained in a [older post]({% post_url 2020-01-10-comparing_colours %}), screens rely on three primary colours: red, green, and blue. Bright red, for example, is mixed using the following values:
...
This issue has something to do with how the [human eye is more sensitive to certain colours]({% post_url 2020-01-10-comparing_colours %}), but to address this, the next method takes human physiology into account to provide improved results.
